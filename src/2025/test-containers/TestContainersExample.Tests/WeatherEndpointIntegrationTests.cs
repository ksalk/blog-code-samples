...
public class CustomContainerIntegrationTests : CustomContainerIntegrationTestBase
{
    [Fact]
    public async Task TestWeatherForecastEndpoint()
    {
...
public class DockerfileContainerIntegrationTests : DockerfileContainerIntegrationTestBase
{
    [Fact]
    public async Task TestWeatherForecastEndpoint()
    {
